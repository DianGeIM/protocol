...
const (
	...
	Friend_GetFriendHash_FullMethodName                 = "/OpenIMServer.friend.friend/getFriendHash"
	Friend_SearchFriends_FullMethodName                 = "/OpenIMServer.friend.friend/searchFriends"
	Friend_IncrSyncFriends_FullMethodName               = "/OpenIMServer.friend.friend/incrSyncFriends"
)
...
func (c *friendClient) GetFriendHash(ctx context.Context, in *GetFriendHashReq, opts ...grpc.CallOption) (*GetFriendHashResp, error) {
	...
	err := c.cc.Invoke(ctx, Friend_GetFriendHash_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendClient) SearchFriends(ctx context.Context, in *SearchFriendsReq, opts ...grpc.CallOption) (*SearchFriendsResp, error) {
	...
	err := c.cc.Invoke(ctx, Friend_SearchFriends_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendClient) IncrSyncFriends(ctx context.Context, in *IncrSyncFriendsReq, opts ...grpc.CallOption) (*IncrSyncFriendsResp, error) {
	...
	err := c.cc.Invoke(ctx, Friend_IncrSyncFriends_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Friend_GetFriendHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_GetFriendHash_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Friend_SearchFriends_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_SearchFriends_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Friend_IncrSyncFriends_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_IncrSyncFriends_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
