...
const (
	...
	Group_SearchGroupMember_FullMethodName               = "/openim.group.group/SearchGroupMember"
	Group_GetGroupMemberHash_FullMethodName              = "/openim.group.group/GetGroupMemberHash"
)
...
func (c *groupClient) SearchGroupMember(ctx context.Context, in *SearchGroupMemberReq, opts ...grpc.CallOption) (*SearchGroupMemberResp, error) {
	...
	err := c.cc.Invoke(ctx, Group_SearchGroupMember_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupClient) GetGroupMemberHash(ctx context.Context, in *GetGroupMemberHashReq, opts ...grpc.CallOption) (*GetGroupMemberHashResp, error) {
	...
	err := c.cc.Invoke(ctx, Group_GetGroupMemberHash_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Group_SearchGroupMember_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Group_SearchGroupMember_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Group_GetGroupMemberHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Group_GetGroupMemberHash_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
